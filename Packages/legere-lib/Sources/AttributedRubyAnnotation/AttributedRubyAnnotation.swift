...
extension AttributeScopes {
    public struct RubyAttributes: AttributeScope {
    ...
    public var ruby: RubyAttributes.Type { RubyAttributes.self }
}

extension AttributeDynamicLookup {
    public subscript<T: AttributedStringKey>(dynamicMember keyPath: KeyPath<AttributeScopes.RubyAttributes, T>) -> T {
        return self[T.self]
    }
}
